    ...
    return (
      ...
      >
        ...
        >
          ...
          {loading || error ? (
            <div className="pointer-events-none absolute bottom-3 left-3 rounded-full border border-white/10 bg-black/40 px-3 py-1 text-[11px] text-cyan-100/80">
              {error ? "OT stream unstable" : "Synchronizing OT scene"}
            </div>
          ) : null}
        </motion.div>
      </motion.div>
